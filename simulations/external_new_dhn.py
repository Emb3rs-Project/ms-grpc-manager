...
from simulations.converters.gis_converter import cf_module_to_create_network, platform_to_create_network, teo_module_to_create_netowrk
...
class ExternalNewDHN(BaseSimulation):
  ...
  def _run(self):
    ...
    def run_cf_convert_sinks():
      ...
      self.request = PlatformOnlyInput(
    ...
    if not self.safe_run_step("GIS Module", "create_network", run_gis_create_network):
      return